...
public class Sequence_growCube : Sequence
{
    ...
    private void growCube()
    {
        ...
        if (DataContainer.Instance.MovingCubeDestination[0].x > DataContainer.Instance.MovingCubeDestination[0].z)
        {
        ...
        StartCoroutine(cubeGrower.growCubeCoroutine(newScale, DataContainer.Instance.CurrentBottomCube, 0.5f));
    }
